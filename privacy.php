    ...
    <main id="main">
      <div class="container my-5" style="margin-top: 150px !important">
        <div>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to AskOncologist.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to AskOncologist, accessible
                from
                <a
                  href="https://askoncologist.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                  >https://askoncologist.com/</a
                >
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: prabhaleo2003@gmail.com</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>By phone number: +91 84069 07980</p>
            </li>
          </ul>
        </div>
      </div>
