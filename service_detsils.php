                        ...
                        <?php if ($blog): ?>
                            <div style="max-height: 380px; overflow-y: auto; padding-right:10px;">
                                ...
                                if (!empty($blog['section1_image']) && file_exists($section1_image_path)): ?>
                                    <div style="display:flex; justify-content:center; align-items:center; width:300px; height:300px;  margin:auto; overflow:hidden; border:1px solid #ddd; border-radius:8px;">
