            ...
            <?php endif; ?>
                                ...
                                <?php if (!empty($blog['section2_image'])): ?>
                                    <div class="d-flex justify-content-center align-items-center mb-3"
                                        ...
                                        <img src="./admin/uploads/photos/<?php echo htmlspecialchars($blog['section2_image']); ?>"
                                            alt="Section 2 Image"
                                ...
                                <?php if (!empty($blog['section3_image'])): ?>
                                    <div class="d-flex justify-content-center align-items-center mb-3"
                                        style="width: 100%; max-width: 500px; height: auto; margin: auto; border:1px solid #ddd; border-radius:8px; overflow:hidden;">
                                        <img src="./admin/uploads/photos/<?php echo htmlspecialchars($blog['section3_image']); ?>"
                                            alt="Section 3 Image"
                                            style="width: 100%; height: auto; object-fit: cover;">
                                    </div>
                                <?php endif; ?>
